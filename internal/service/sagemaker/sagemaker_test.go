...
func TestAccSageMaker_serial(t *testing.T) {
	...
	testCases := map[string]map[string]func(t *testing.T){
		...
		"Model": {
			"basic":                                 TestAccSageMakerModel_basic,
			"disappears":                            TestAccSageMakerModel_disappears,
			"inferenceExecution":                    TestAccSageMakerModel_inferenceExecution,
			"tags":                                  TestAccSageMakerModel_tags,
			"vpc":                                   TestAccSageMakerModel_vpc,
			"networkIsolation":                      TestAccSageMakerModel_networkIsolation,
			"primaryContainerModelDataUrl":          TestAccSageMakerModel_primaryContainerModelDataURL,
			"primaryContainerHostName":              TestAccSageMakerModel_primaryContainerHostname,
			"primaryContainerImage":                 TestAccSageMakerModel_primaryContainerImage,
			"primaryContainerEnvironment":           TestAccSageMakerModel_primaryContainerEnvironment,
			"primaryContainerModeSingle":            TestAccSageMakerModel_primaryContainerModeSingle,
			"primaryContainerModelPackageName":      TestAccSageMakerModel_primaryContainerModelPackageName,
		...
		"Space": {
			...
			"disappears":               testAccSpace_disappears,
